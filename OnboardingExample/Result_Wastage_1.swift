...
class Result_Wastage_1: UIViewController, UIGestureRecognizerDelegate {
    ...
    @objc func buttonAction(sender: UIButton!) {
        ...
        performSegue(withIdentifier: "wastage_1_ana", sender: self)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if( segue.identifier == "wastage_1_ana" ){
    ...
    @IBAction func log_out_button(_ sender: Any) {
        ...
        PFUser.logOutInBackground { (error: Error?) in
            if (error == nil){
                ...
                self.performSegue(withIdentifier: "wastage_1_login", sender: nil)
                print("çıkıldı")
