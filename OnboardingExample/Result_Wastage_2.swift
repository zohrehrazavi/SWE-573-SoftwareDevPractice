...
class Result_Wastage_2: UIViewController , UIGestureRecognizerDelegate{
    ...
    let Q2_WASTAGE_3   :[Double] =  [   3,    9.0,    0.30,    1,    0.30,    999,    999,    999,    999,    999,    999,    1,    999    ]
    let Q2_WASTAGE_4   :[Double] =  [   4,    12.0,    0.40,    1,    0.40,    999,    999,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_5   :[Double] =  [   5,    15.0,    0.50,    1,    0.50,    999,    999,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_6   :[Double] =  [   6,    18.0,    0.60,    1,    0.60,    999,    999,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_7   :[Double] =  [   7,    21.0,    0.70,    1,    0.70,    999,    999,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_8   :[Double] =  [   8,    24.0,    0.80,    1,    0.80,    999,    999,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_9   :[Double] =  [   9,    27.0,    0.90,    1,    0.90,    999,    999,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_10  : [Double] = [ 10,    30.0,    1.00,    1,    1.00,    999,    999,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_11  : [Double] = [ 11,    33.0,    0.22,    999,    999,    1,    0.22,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_12  : [Double] = [ 12,    36.0,    0.24,    999,    999,    1,    0.24,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_13  : [Double] = [ 13,    39.0,    0.26,    999,    999,    1,    0.26,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_14  : [Double] = [ 14,    42.0,    0.28,    999,    999,    1,    0.28,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_15  : [Double] = [ 15,    45.0,    0.30,    999,    999,    1,    0.30,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_16  : [Double] = [ 16,    48.0,    0.32,    999,    999,    1,    0.32,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_17  : [Double] = [ 17,    51.0,    0.34,    999,    999,    1,    0.34,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_18  : [Double] = [ 18,    54.0,    0.36,    999,    999,    1,    0.36,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_19  : [Double] = [ 19,    57.0,    0.38,    999,    999,    1,    0.38,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_20  : [Double] = [ 20,    60.0,    0.40,    999,    999,    1,    0.40,    999,    999,    999,    999,    1,    999     ]
    ...
    let Q2_WASTAGE_31  : [Double] = [ 31,    93.0,    0.62,    999,    999,    999,    999,    1,    0.62,    999,    999,    1,    999     ]
    let Q2_WASTAGE_32  : [Double] = [ 32,    96.0,    0.64,    999,    999,    999,    999,    1,    0.64,    999,    999,    1,    999    ]
    let Q2_WASTAGE_33  : [Double] = [ 33,    99.0,    0.66,    999,    999,    999,    999,    1,    0.66,    999,    999,    1,    999     ]
    let Q2_WASTAGE_34  : [Double] = [ 34,    102.0,    0.68,    999,    999,    999,    999,    1,    0.68,    999,    999,    1,    999     ]
    let Q2_WASTAGE_35  : [Double] = [ 35,    105.0,    0.70,    999,    999,    999,    999,    1,    0.70,    999,    999,    1,    999     ]
    let Q2_WASTAGE_36  : [Double] = [ 36,    108.0,    0.72,    999,    999,    2,    0.72,    999,    999,    999,    999,    1,    999    ]
    let Q2_WASTAGE_37  : [Double] = [ 37,    111.0,    0.74,    999,    999,    2,    0.74,    999,    999,    999,    999,    1,    99     ]
    let Q2_WASTAGE_38  : [Double] = [ 38,    114.0,    0.76,    999,    999,    2,    0.76,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_39  : [Double] = [ 39,    117.0,    0.78,    999,    999,    2,    0.78,    999,    999,    999,    999,    1,    999     ]
    let Q2_WASTAGE_40  : [Double] = [ 40,    120.0,    0.80,    999,    999,    2,    0.80,    999,    999,    999,    999,    1,    999     ]
    ...
    let Q2_WASTAGE_46  : [Double] = [ 46,    138.0,    0.92,    999,    999,    999,    999,    999,    999,    1,    0.92,    1,    999     ]
    let Q2_WASTAGE_47  : [Double] = [ 47,    141.0,    0.94,    999,    999,    999,    999,    999,    999,    1,    0.94,    1,    999     ]
    let Q2_WASTAGE_48  : [Double] = [ 48,    144.0,    0.96,    999,    999,    999,    999,    999,    999,    1,    0.96,    1,    999     ]
    let Q2_WASTAGE_49  : [Double] = [ 49,    147.0,    0.98,    999,    999,    999,    999,    999,    999,    1,    0.98,    1,    999     ]
    let Q2_WASTAGE_50  : [Double] = [ 50,    150.0,    1.00,    999,    999,    999,    999,    999,    999,    1,    1.00,    1,    999     ]
    ...
    let Q2_WASTAGE_56  : [Double] = [ 56,    168.0,    1.12,    999,    999,    3,    1.12,    999,    999,    999,    999,    999,   1  ]
    let Q2_WASTAGE_57  : [Double] = [ 57,    171.0,    1.14,    999,    999,    3,    1.14,    999,    999,    999,    999,    999,   1  ]
    let Q2_WASTAGE_58  : [Double] = [ 58,    174.0,    1.16,    999,    999,    3,    1.16,    999,    999,    999,    999,    999,   1  ]
    let Q2_WASTAGE_59  : [Double] = [ 59,    177.0,    1.18,    999,    999,    3,    1.18,    999,    999,    999,    999,    999,   1  ]
    let Q2_WASTAGE_60  : [Double] = [ 60,    180.0,    1.20,    999,    999,    3,    1.20,    999,    999,    999,    999,    999,   1  ]
    ...
    let Q2_WASTAGE_66  : [Double] = [ 66,    198.0,    1.32,    999,    999,    999,    999,    2,    1.32,    999,    999,    999,  1   ]
    let Q2_WASTAGE_67  : [Double] = [ 67,    201.0,    1.34,    999,    999,    999,    999,    2,    1.34,    999,    999,    999,  1   ]
    let Q2_WASTAGE_68  : [Double] = [ 68,    204.0,    1.36,    999,    999,    999,    999,    2,    1.36,    999,    999,    999,   1  ]
    let Q2_WASTAGE_69  : [Double] = [ 69,    207.0,    1.38,    999,    999,    999,    999,    2,    1.38,    999,    999,    999,  1   ]
    let Q2_WASTAGE_70  : [Double] = [ 70,    210.0,    1.40,    999,    999,    999,    999,    2,    1.40,    999,    999,    999,   1  ]
    ...
    let Q2_WASTAGE_76  : [Double] = [ 76,    228.0,    1.52,    999,    999,    4,    1.52,    999,    999,    999,    999,    999,   1  ]
    let Q2_WASTAGE_77  : [Double] = [ 77,    231.0,    1.54,    999,    999,    4,    1.54,    999,    999,    999,    999,    999,  1   ]
    let Q2_WASTAGE_78  : [Double] = [ 78,    234.0,    1.56,    999,    999,    4,    1.56,    999,    999,    999,    999,    999,  1   ]
    let Q2_WASTAGE_79  : [Double] = [ 79,    237.0,    1.58,    999,    999,    4,    1.58,    999,    999,    999,    999,    999,   1  ]
    let Q2_WASTAGE_80  : [Double] = [ 80,    240.0,    1.60,    999,    999,    4,    1.60,    999,    999,    999,    999,    999,   1  ]
    ...
    let Q2_WASTAGE_96  : [Double] = [ 96,    288.0,    1.92,    999,    999,    999,    999,    999,    999,    2,    1.92,    999,  1   ]
    let Q2_WASTAGE_97  : [Double] = [ 97,    291.0,    1.94,    999,    999,    999,    999,    999,    999,    2,    1.94,    999,  1   ]
    let Q2_WASTAGE_98  : [Double] = [ 98,    294.0,    1.96,    999,    999,    999,    999,    999,    999,    2,    1.96,    999,  1   ]
    let Q2_WASTAGE_99  : [Double] = [ 99,    297.0,    1.98,    999,    999,    999,    999,    999,    999,    2,    1.98,    999,  1   ]
    let Q2_WASTAGE_100 :[Double] =  [ 100,    300.0,    2.00,    999,    999,    999,    999,    999,    999,    2,    2.00,    999,  1   ]
    ...
    override func viewDidLoad() {
        ...
        if (kilo==3  ){
            ...
            aranacak_dizi = Q2_WASTAGE_3
            
            
        }
        else  if (kilo == 4 ){
            
            aranacak_dizi = Q2_WASTAGE_4
            
        }else if (kilo==5  ){
            
            aranacak_dizi = Q2_WASTAGE_5
            
            
        }
        else  if (kilo == 6 ){
            
            aranacak_dizi = Q2_WASTAGE_6
            
        }else  if (kilo == 7 ){
            
            aranacak_dizi = Q2_WASTAGE_7
            
        }else if (kilo==8  ){
            
            aranacak_dizi = Q2_WASTAGE_8
            
            
        }
        else  if (kilo == 9 ){
            
            aranacak_dizi = Q2_WASTAGE_9
            
        }else  if (kilo == 10 ){
            
            aranacak_dizi = Q2_WASTAGE_10
            
        } else if (kilo == 11 ){
            
            aranacak_dizi = Q2_WASTAGE_11
            
            
        }
        else  if (kilo == 12 ){
            
            aranacak_dizi = Q2_WASTAGE_12
            ...
            aranacak_dizi = Q2_WASTAGE_14
            
        }else  if (kilo == 15 ){
            
            aranacak_dizi = Q2_WASTAGE_15
            
        }else if (kilo == 16  ){
            
            aranacak_dizi = Q2_WASTAGE_16
            
            
        }else  if (kilo == 17 ){
            
            aranacak_dizi = Q2_WASTAGE_17
            
        }else  if (kilo == 18 ){
            
            aranacak_dizi = Q2_WASTAGE_18
            
        }else  if (kilo == 19 ){
            
            aranacak_dizi = Q2_WASTAGE_19
            
        }else  if (kilo == 20 ){
            
            aranacak_dizi = Q2_WASTAGE_20
            
        }else  if (kilo == 21 ){
            
            aranacak_dizi = Q2_WASTAGE_21
            
        }else if (kilo == 22  ){
            
            aranacak_dizi = Q2_WASTAGE_22
            
            
        }
        else  if (kilo == 23 ){
            
            aranacak_dizi = Q2_WASTAGE_23
            
        }else  if (kilo == 24 ){
            
            aranacak_dizi = Q2_WASTAGE_24
            
        }else if (kilo == 25  ){
            
            aranacak_dizi = Q2_WASTAGE_25
            
            
        }
        else  if (kilo == 26 ){
            
            aranacak_dizi = Q2_WASTAGE_26
            
        }else  if (kilo == 27 ){
            
            aranacak_dizi = Q2_WASTAGE_27
            
        } else if (kilo == 28 ){
            
            aranacak_dizi = Q2_WASTAGE_28
            
            
        }
        else  if (kilo == 29 ){
            
            aranacak_dizi = Q2_WASTAGE_29
            
        }else if (kilo == 30  ){
            
            aranacak_dizi = Q2_WASTAGE_30
            
            
        }
        else  if (kilo == 31 ){
            
            aranacak_dizi = Q2_WASTAGE_31
            
        }else  if (kilo == 32 ){
            
            aranacak_dizi = Q2_WASTAGE_32
            
        }else if (kilo == 33  ){
            
            aranacak_dizi = Q2_WASTAGE_33
            
            
        }
        else  if (kilo == 34 ){
            
            aranacak_dizi = Q2_WASTAGE_34
            
        }else  if (kilo == 35 ){
            
            aranacak_dizi = Q2_WASTAGE_35
            
        }else  if (kilo == 36 ){
            
            aranacak_dizi = Q2_WASTAGE_36
            
        }else  if (kilo == 37 ){
            
            aranacak_dizi = Q2_WASTAGE_37
            
        }else  if (kilo == 38 ){
            
            aranacak_dizi = Q2_WASTAGE_38
            
        }else if (kilo == 39  ){
            
            aranacak_dizi = Q2_WASTAGE_39
            
            
        }
        else  if (kilo == 40 ){
            
            aranacak_dizi = Q2_WASTAGE_40
            
        }else  if (kilo == 41 ){
            
            aranacak_dizi = Q2_WASTAGE_41
            
        }else if (kilo == 42  ){
            
            aranacak_dizi = Q2_WASTAGE_42
            
            
        }
        else  if (kilo == 43 ){
            
            aranacak_dizi = Q2_WASTAGE_43
            
        }else  if (kilo == 44 ){
            
            aranacak_dizi = Q2_WASTAGE_45
            
        } else if (kilo == 46 ){
            
            aranacak_dizi = Q2_WASTAGE_46
            
            
        }
        else  if (kilo == 47 ){
            
            aranacak_dizi = Q2_WASTAGE_47
            
        }else if (kilo == 48  ){
            
            aranacak_dizi = Q2_WASTAGE_48
            
            
        }
        else  if (kilo == 49 ){
            
            aranacak_dizi = Q2_WASTAGE_49
            
        }else  if (kilo == 50 ){
            
            aranacak_dizi = Q2_WASTAGE_50
            
        }else if (kilo == 51  ){
            
            aranacak_dizi = Q2_WASTAGE_51
            
            
        }
        else  if (kilo == 52 ){
            
            aranacak_dizi = Q2_WASTAGE_52
            
        }else  if (kilo == 53 ){
            
            aranacak_dizi = Q2_WASTAGE_53
            
        }else  if (kilo == 54 ){
            
            aranacak_dizi = Q2_WASTAGE_54
            
        }else  if (kilo == 55 ){
            
            aranacak_dizi = Q2_WASTAGE_55
            
        }else  if (kilo == 56 ){
            
            aranacak_dizi = Q2_WASTAGE_56
            
        }else if (kilo == 57  ){
            
            aranacak_dizi = Q2_WASTAGE_57
            
            
        }
        else  if (kilo == 58 ){
            
            aranacak_dizi = Q2_WASTAGE_58
            
        }else  if (kilo == 59 ){
            
            aranacak_dizi = Q2_WASTAGE_59
            
        }else if (kilo == 60  ){
            
            aranacak_dizi = Q2_WASTAGE_60
            
            
        }else if (kilo == 61  ){
            
            aranacak_dizi = Q2_WASTAGE_61
            
            
        }else if (kilo == 62  ){
            
            aranacak_dizi = Q2_WASTAGE_62
            
            
        }else if (kilo == 63  ){
            
            aranacak_dizi = Q2_WASTAGE_63
            
            
        }else if (kilo == 64  ){
            
            aranacak_dizi = Q2_WASTAGE_64
            
            
        }else if (kilo == 65  ){
            
            aranacak_dizi = Q2_WASTAGE_65
            
            
        }else if (kilo == 66  ){
            
            aranacak_dizi = Q2_WASTAGE_66
            
            
        }else if (kilo == 67  ){
            
            aranacak_dizi = Q2_WASTAGE_67
            
            
        }else if (kilo == 68  ){
            
            aranacak_dizi = Q2_WASTAGE_68
            
            
        }else if (kilo == 69  ){
            
            aranacak_dizi = Q2_WASTAGE_69
            ...
            aranacak_dizi = Q2_WASTAGE_70
            
        }else  if (kilo == 71 ){
            
            aranacak_dizi = Q2_WASTAGE_71
            
        } else if (kilo == 72 ){
            
            aranacak_dizi = Q2_WASTAGE_72
            
            
        }
        else  if (kilo == 73 ){
            
            aranacak_dizi = Q2_WASTAGE_73
            
        }else if (kilo == 74  ){
            
            aranacak_dizi = Q2_WASTAGE_74
            
            
        }
        else  if (kilo == 75 ){
            
            aranacak_dizi = Q2_WASTAGE_75
            
        }else  if (kilo == 76 ){
            
            aranacak_dizi = Q2_WASTAGE_76
            
        }else if (kilo == 77  ){
            
            aranacak_dizi = Q2_WASTAGE_77
            
            
        }
        else  if (kilo == 78 ){
            
            aranacak_dizi = Q2_WASTAGE_78
            
        }else  if (kilo == 79 ){
            
            aranacak_dizi = Q2_WASTAGE_79
            
        }else  if (kilo == 80 ){
            
            aranacak_dizi = Q2_WASTAGE_80
            
        }else  if (kilo == 81 ){
            
            aranacak_dizi = Q2_WASTAGE_81
            
        }else  if (kilo == 82 ){
            
            aranacak_dizi = Q2_WASTAGE_82
            
        }else if (kilo == 83  ){
            
            aranacak_dizi = Q2_WASTAGE_83
            
            
        }
        else  if (kilo == 84 ){
            
            aranacak_dizi = Q2_WASTAGE_84
            
        }else  if (kilo == 85 ){
            
            aranacak_dizi = Q2_WASTAGE_85
            
        }else if (kilo == 86 ){
            
            aranacak_dizi = Q2_WASTAGE_86
            
            
        }
        else  if (kilo == 87 ){
            
            aranacak_dizi = Q2_WASTAGE_87
            
        }else  if (kilo == 88 ){
            
            aranacak_dizi = Q2_WASTAGE_88
            
        } else if (kilo == 89 ){
            
            aranacak_dizi = Q2_WASTAGE_89
            
            
        }
        else  if (kilo == 90 ){
            
            aranacak_dizi = Q2_WASTAGE_90
            
        }else if (kilo == 91  ){
            
            aranacak_dizi = Q2_WASTAGE_91
            
            
        }
        else  if (kilo == 92 ){
            
            aranacak_dizi = Q2_WASTAGE_92
            
        }else  if (kilo == 93 ){
            
            aranacak_dizi = Q2_WASTAGE_93
            
        }else if (kilo == 94  ){
            
            aranacak_dizi = Q2_WASTAGE_94
            
            
        }
        else  if (kilo == 95 ){
            
            aranacak_dizi = Q2_WASTAGE_95
            
        }else  if (kilo == 96 ){
            
            aranacak_dizi = Q2_WASTAGE_96
            
        }else  if (kilo == 97 ){
            
            aranacak_dizi = Q2_WASTAGE_97
            
        }else  if (kilo == 98 ){
            
            aranacak_dizi = Q2_WASTAGE_98
            
        }else  if (kilo == 99 ){
            
            aranacak_dizi = Q2_WASTAGE_99
            
        }else if (kilo == 100  ){
            
            aranacak_dizi = Q2_WASTAGE_100
            
            
        }
        else  if (kilo == 101 ){
            
            aranacak_dizi = Q2_WASTAGE_101
            
        }else  if (kilo == 102 ){
            
            aranacak_dizi = Q2_WASTAGE_102
            
        }else if (kilo == 103  ){
            
            aranacak_dizi = Q2_WASTAGE_103
            
            
        }
        else  if (kilo == 104 ){
            
            aranacak_dizi = Q2_WASTAGE_104
            
        }else  if (kilo == 105 ){
            
            aranacak_dizi = Q2_WASTAGE_105
            
        } else if (kilo == 106 ){
            
            aranacak_dizi = Q2_WASTAGE_106
            
            
        }
        else  if (kilo == 107 ){
            
            aranacak_dizi = Q2_WASTAGE_107
            
        }else if (kilo == 108  ){
            
            aranacak_dizi = Q2_WASTAGE_108
            
            
        }
        else  if (kilo == 109 ){
            
            aranacak_dizi = Q2_WASTAGE_109
            
        }else  if (kilo == 110 ){
            
            aranacak_dizi = Q2_WASTAGE_110
            
        }else if (kilo == 111  ){
            
            aranacak_dizi = Q2_WASTAGE_111
            
            
        }
        else  if (kilo == 112 ){
            
            aranacak_dizi = Q2_WASTAGE_112
            
        }else  if (kilo == 113 ){
            
            aranacak_dizi = Q2_WASTAGE_113
            
        }else  if (kilo == 114 ){
            
            aranacak_dizi = Q2_WASTAGE_115
            
        }else  if (kilo == 116 ){
            
            aranacak_dizi = Q2_WASTAGE_117
            
        }else  if (kilo == 118 ){
            
            aranacak_dizi = Q2_WASTAGE_118
            
        }else if (kilo == 119  ){
            
            aranacak_dizi = Q2_WASTAGE_119
            
            
        }
        else  if (kilo == 120 ){
            
            aranacak_dizi = Q2_WASTAGE_120
            
        }else  if (kilo == 121 ){
            
            aranacak_dizi = Q2_WASTAGE_121
            
        }else if (kilo == 122  ){
            
            aranacak_dizi = Q2_WASTAGE_122
            
            
        }
        else  if (kilo == 123 ){
            
            aranacak_dizi = Q2_WASTAGE_123
            
        }else  if (kilo == 124 ){
            
            aranacak_dizi = Q2_WASTAGE_124
            
        } else if (kilo == 125 ){
            
            aranacak_dizi = Q2_WASTAGE_125
            
            
        }
        else  if (kilo == 126 ){
            
            aranacak_dizi = Q2_WASTAGE_126
            
        }else if (kilo == 127  ){
            
            aranacak_dizi = Q2_WASTAGE_127
            
            
        }
        else  if (kilo == 128 ){
            
            aranacak_dizi = Q2_WASTAGE_128
            
        }else  if (kilo == 129 ){
            
            aranacak_dizi = Q2_WASTAGE_129
            
        }else if (kilo == 130  ){
            
            aranacak_dizi = Q2_WASTAGE_130
            
            
        }
        else  if (kilo == 131 ){
            
            aranacak_dizi = Q2_WASTAGE_131
            
        }else  if (kilo == 132 ){
            
            aranacak_dizi = Q2_WASTAGE_132
            
        }else  if (kilo == 133 ){
            
            aranacak_dizi = Q2_WASTAGE_133
            
        }else  if (kilo == 134 ){
            
            aranacak_dizi = Q2_WASTAGE_134
            
        }else  if (kilo == 135 ){
            
            aranacak_dizi = Q2_WASTAGE_135
            
        }else  if (kilo == 136 ){
            
            aranacak_dizi = Q2_WASTAGE_136
            
        }else if (kilo == 137  ){
            
            aranacak_dizi = Q2_WASTAGE_137
            
            
        }
        else  if (kilo == 138 ){
            
            aranacak_dizi = Q2_WASTAGE_138
            
        }else  if (kilo == 139 ){
            
            aranacak_dizi = Q2_WASTAGE_139
            
        } else if (kilo == 140 ){
            
            aranacak_dizi = Q2_WASTAGE_140
            
            
        }
        else  if (kilo == 141 ){
            
            aranacak_dizi = Q2_WASTAGE_141
            
        }else if (kilo == 142  ){
            
            aranacak_dizi = Q2_WASTAGE_142
            
            
        }
        else  if (kilo == 143 ){
            
            aranacak_dizi = Q2_WASTAGE_143
            
        }else  if (kilo == 144 ){
            
            aranacak_dizi = Q2_WASTAGE_144
            
        }else if (kilo == 145  ){
            
            aranacak_dizi = Q2_WASTAGE_145
            
            
        }
        else  if (kilo == 146 ){
            
            aranacak_dizi = Q2_WASTAGE_146
            
        }else  if (kilo == 147 ){
            
            aranacak_dizi = Q2_WASTAGE_147
            
        }else  if (kilo == 148 ){
            
            aranacak_dizi = Q2_WASTAGE_148
            
        }else  if (kilo == 149 ){
            
            aranacak_dizi = Q2_WASTAGE_149
            
        }else  if (kilo == 150 ){
            
            aranacak_dizi = Q2_WASTAGE_150
    ...
    @objc func buttonAction(sender: UIButton!) {
        ...
        performSegue(withIdentifier: "wastage_2_ana", sender: self)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if( segue.identifier == "wastage_2_ana" ){
    ...
    @IBAction func menu_aciton(_ sender: Any) {
    ...
    @IBAction func pan_gesture_1(_ sender: UIPanGestureRecognizer) {
    ...
    @IBAction func log_out_button(_ sender: Any) {
        ...
        PFUser.logOutInBackground { (error: Error?) in
            if (error == nil){
                ...
                self.performSegue(withIdentifier: "wastage_2_login", sender: nil)
                print("çıkıldı")
