...
class ViewController: UIViewController, UIScrollViewDelegate {
    ...
    @IBAction func ileri_button(_ sender: Any) {
    ...
    func createSlides() -> [Slide] {
        ...
        slide1.imageView.image = UIImage(named: "int_pic_1")
        slide1.labelTitle.text = "PATIENT WEIGHT"
        slide1.labelDesc.text = "This application aims to help physicians calculating the appropriate weight-based dose."
        
        let slide2:Slide = Bundle.main.loadNibNamed("Slide", owner: self, options: nil)?.first as! Slide
        slide2.imageView.image = UIImage(named: "int_pic_2")
        ...
        slide3.imageView.image = UIImage(named: "int_pic_3")
