...
class Result_Injections_1: UIViewController, UIGestureRecognizerDelegate {
    ...
    let Q1_WASTAGE_41  : [Double] = [41,    61.5,    0.41,    999,    999,    999,    999,    1,    0.41,    999,    999,    2,    999]
    let Q1_WASTAGE_42  : [Double] = [42,    63.0,    0.42,    999,    999,    999,    999,    1,    0.42,    999,    999,    2,    999]
    let Q1_WASTAGE_43  : [Double] = [43,    64.5,    0.43,    999,    999,    999,    999,    1,    0.43,    999,    999,    2,    999]
    let Q1_WASTAGE_44  : [Double] = [44,    66.0,    0.44,    999,    999,    999,    999,    1,    0.44,    999,    999,    2,    999]
    let Q1_WASTAGE_45  : [Double] = [45,    67.5,    0.45,    999,    999,    999,    999,    1,    0.45,    999,    999,    2,    999]
    let Q1_WASTAGE_46  : [Double] = [46,    69.0,    0.46,    999,    999,    999,    999,    1,    0.46,    999,    999,    2,    999]
    let Q1_WASTAGE_47  : [Double] = [47,    70.5,    0.47,    999,    999,    999,    999,    1,    0.47,    999,    999,    2,    999]
    let Q1_WASTAGE_48  : [Double] = [48,    72.0,    0.48,    999,    999,    999,    999,    1,    0.48,    999,    999,    2,    999]
    let Q1_WASTAGE_49  : [Double] = [49,    73.5,    0.49,    999,    999,    999,    999,    1,    0.49,    999,    999,    2,    999]
    let Q1_WASTAGE_50  : [Double] = [50,    75.0,    0.5,    999,    999,    999,    999,    1,    0.50,    999,    999,    2,    999]
    let Q1_WASTAGE_51  : [Double] = [51,    76.5,    0.51,    999,    999,    999,    999,    1,    0.51,    999,    999,    2,    999]
    let Q1_WASTAGE_52  : [Double] = [52,    78.0,    0.52,    999,    999,    999,    999,    1,    0.52,    999,    999,    2,    999]
    let Q1_WASTAGE_53  : [Double] = [53,    79.5,    0.53,    999,    999,    999,    999,    1,    0.53,    999,    999,    2,    999]
    let Q1_WASTAGE_54  : [Double] = [54,    81.0,    0.54,    999,    999,    999,    999,    1,    0.54,    999,    999,    2,    999]
    let Q1_WASTAGE_55  : [Double] = [55,    82.5,    0.55,    999,    999,    999,    999,    1,    0.55,    999,    999,    2,    999]
    let Q1_WASTAGE_56  : [Double] = [56,    84.0,    0.56,    999,    999,    999,    999,    1,    0.56,    999,    999,    2,    999]
    let Q1_WASTAGE_57  : [Double] = [57,    85.5,    0.57,    999,    999,    999,    999,    1,    0.57,    999,    999,    2,    999]
    let Q1_WASTAGE_58  : [Double] = [58,    87.0,    0.58,    999,    999,    999,    999,    1,    0.58,    999,    999,    2,    999]
    let Q1_WASTAGE_59  : [Double] = [59,    88.5,    0.59,    999,    999,    999,    999,    1,    0.59,    999,    999,    2,    999]
    let Q1_WASTAGE_60  : [Double] = [60,    90.0,    0.6,    999,    999,    999,    999,    1,    0.60,    999,    999,    2,    999]
    ...
    let Q1_WASTAGE_71  : [Double] = [71,    106.5,    0.71,    999,    999,    999,    999,    999,    999,    1,    0.71,    1,    999]
    let Q1_WASTAGE_72  : [Double] = [72,    108.0,    0.72,    999,    999,    999,    999,    999,    999,    1,    0.72,    1,    999]
    let Q1_WASTAGE_73  : [Double] = [73,    109.5,    0.73,    999,    999,    999,    999,    999,    999,    1,    0.73,    1,    999]
    let Q1_WASTAGE_74  : [Double] = [74,    111.0,    0.74,    999,    999,    999,    999,    999,    999,    1,    0.74,    1,    999]
    let Q1_WASTAGE_75  : [Double] = [75,    112.5,    0.75,    999,    999,    999,    999,    999,    999,    1,    0.75,    1,    999]
    let Q1_WASTAGE_76  : [Double] = [76,    114.0,    0.76,    999,    999,    999,    999,    999,    999,    1,    0.76,    1,    999]
    let Q1_WASTAGE_77  : [Double] = [77,    115.5,    0.77,    999,    999,    999,    999,    999,    999,    1,    0.77,    1,    999]
    let Q1_WASTAGE_78  : [Double] = [78,    117.0,    0.78,    999,    999,    999,    999,    999,    999,    1,    0.78,    1,    999]
    let Q1_WASTAGE_79  : [Double] = [79,    118.5,    0.79,    999,    999,    999,    999,    999,    999,    1,    0.79,    1,    999]
    let Q1_WASTAGE_80  : [Double] = [80,    120.0,    0.8,    999,    999,    999,    999,    999,    999,    1,    0.80,    1,    999]
    let Q1_WASTAGE_81  : [Double] = [81,    121.5,    0.81,    999,    999,    999,    999,    999,    999,    1,    0.81,    1,    999]
    let Q1_WASTAGE_82  : [Double] = [82,    123.0,    0.82,    999,    999,    999,    999,    999,    999,    1,    0.82,    1,    999]
    let Q1_WASTAGE_83  : [Double] = [83,    124.5,    0.83,    999,    999,    999,    999,    999,    999,    1,    0.83,    1,    999]
    let Q1_WASTAGE_84  : [Double] = [84,    126.0,    0.84,    999,    999,    999,    999,    999,    999,    1,    0.84,    1,    999]
    let Q1_WASTAGE_85  : [Double] = [85,    127.5,    0.85,    999,    999,    999,    999,    999,    999,    1,    0.85,    1,    999]
    let Q1_WASTAGE_86  : [Double] = [86,    129.0,    0.86,    999,    999,    999,    999,    999,    999,    1,    0.86,    1,    999]
    let Q1_WASTAGE_87  : [Double] = [87,    130.5,    0.87,    999,    999,    999,    999,    999,    999,    1,    0.87,    1,    999]
    let Q1_WASTAGE_88  : [Double] = [88,    132.0,    0.88,    999,    999,    999,    999,    999,    999,    1,    0.88,    1,    999]
    let Q1_WASTAGE_89  : [Double] = [89,    133.5,    0.89,    999,    999,    999,    999,    999,    999,    1,    0.89,    1,    999]
    let Q1_WASTAGE_90  : [Double] = [90,    135.0,    0.9,    999,    999,    999,    999,    999,    999,    1,    0.90,    1,    999]
    ...
    let Q1_WASTAGE_103 :[Double] =  [103,    154.5,    1.03,    999,    999,    1,    0.33,    1,    0.70,    999,    999,    999,    1  ]
    ...
    let Q1_WASTAGE_111 :[Double] =  [111,    166.5,    1.11,    999,    999,    1,    0.11,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_112 :[Double] =  [112,    168.0,    1.12,    999,    999,    1,    0.12,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_113 :[Double] =  [113,    169.5,    1.13,    999,    999,    1,    0.13,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_114 :[Double] =  [114,    171.0,    1.14,    999,    999,    1,    0.14,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_115 :[Double] =  [115,    172.5,    1.15,    999,    999,    1,    0.15,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_116 :[Double] =  [116,    174.0,    1.16,    999,    999,    1,    0.16,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_117 :[Double] =  [117,    175.5,    1.17,    999,    999,    1,    0.17,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_118 :[Double] =  [118,    177.0,    1.18,    999,    999,    1,    0.18,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_119 :[Double] =  [119,    178.5,    1.19,    999,    999,    1,    0.19,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_120 :[Double] =  [120,    180.0,    1.20,    999,    999,    1,    0.20,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_121 :[Double] =  [121,    181.5,    1.21,    999,    999,    1,    0.21,    999,    999,    1,    1.00,    1,    1      ]
    let Q1_WASTAGE_122 :[Double] =  [122,    183.0,    1.22,    999,    999,    1,    0.22,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_123 :[Double] =  [123,    184.5,    1.23,    999,    999,    1,    0.23,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_124 :[Double] =  [124,    186.0,    1.24,    999,    999,    1,    0.24,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_125 :[Double] =  [125,    187.5,    1.25,    999,    999,    1,    0.25,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_126 :[Double] =  [126,    189.0,    1.26,    999,    999,    1,    0.26,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_127 :[Double] =  [127,    190.5,    1.27,    999,    999,    1,    0.27,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_128 :[Double] =  [128,    192.0,    1.28,    999,    999,    1,    0.28,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_129 :[Double] =  [129,    193.5,    1.29,    999,    999,    1,    0.29,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_130 :[Double] =  [130,    195.0,    1.3,    999,    999,    1,    0.30,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_131 :[Double] =  [131,    196.5,    1.31,    999,    999,    1,    0.31,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_132 :[Double] =  [132,    198.0,    1.32,    999,    999,    1,    1.32,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_133 :[Double] =  [133,    199.5,    1.33,    999,    999,    1,    1.33,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_134 :[Double] =  [134,    201.0,    1.34,    999,    999,    1,    1.34,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_135 :[Double] =  [135,    202.5,    1.35,    999,    999,    1,    1.35,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_136 :[Double] =  [136,    204.0,    1.36,    999,    999,    1,    1.36,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_137 :[Double] =  [137,    205.5,    1.37,    999,    999,    1,    1.37,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_138 :[Double] =  [138,    207.0,    1.38,    999,    999,    1,    1.38,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_139 :[Double] =  [139,    208.5,    1.39,    999,    999,    1,    1.39,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_140 :[Double] =  [140,    210.0,    1.40,    999,    999,    1,    1.40,    999,    999,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_141 :[Double] =  [141,    211.5,    1.41,    999,    999,    999,    999,    1,    0.41,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_142 :[Double] =  [142,    213.0,    1.42,    999,    999,    999,    999,    1,    0.42,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_143 :[Double] =  [143,    214.5,    1.43,    999,    999,    999,    999,    1,    0.43,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_144 :[Double] =  [144,    216.0,    1.44,    999,    999,    999,    999,    1,    0.44,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_145 :[Double] =  [145,    217.5,    1.45,    999,    999,    999,    999,    1,    0.45,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_146 :[Double] =  [146,    219.0,    1.46,    999,    999,    999,    999,    1,    0.46,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_147 :[Double] =  [147,    220.5,    1.47,    999,    999,    999,    999,    1,    0.47,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_148 :[Double] =  [148,    222.0,    1.48,    999,    999,    999,    999,    1,    0.48,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_149 :[Double] =  [149,    223.5,    1.49,    999,    999,    999,    999,    1,    0.49,    1,    1.00,    999,    1  ]
    let Q1_WASTAGE_150 :[Double] =  [150,    225.0,    1.50,    999,    999,    999,    999,    1,    0.50,    1,    1.00,    999,    1  ]
    ...
    override func viewDidLoad() {
        ...
        total_dose_değeri_int = kilo * 3/2
    ...
    @objc func buttonAction(sender: UIButton!) {
        ...
        performSegue(withIdentifier: "injections_1_ana", sender: self)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if( segue.identifier == "injections_1_ana" ){
    ...
    @IBAction func log_out_button(_ sender: Any) {
        ...
        PFUser.logOutInBackground { (error: Error?) in
            if (error == nil){
                ...
                self.performSegue(withIdentifier: "injections_1_login", sender: nil)
                print("çıkıldı")
