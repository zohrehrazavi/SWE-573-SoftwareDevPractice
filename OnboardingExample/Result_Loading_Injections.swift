//
//  Result_Loading_Injections.swift
//  OnboardingExample
//
...
class Result_Loading_Injections: UIViewController,UIGestureRecognizerDelegate {
    ...
    @objc func buttonAction(sender: UIButton!) {
        ...
        performSegue(withIdentifier: "loading_injections_ana", sender: self)
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if( segue.identifier == "loading_injections_ana" ){
    ...
    @IBAction func menu_button_action(_ sender: Any) {
        ...
        UIView.animate(withDuration: 0.2, animations:{
            ...
            self.menu_constraint.constant = 0
        ...
        if sender.state == .began {
            ...
            if vel.x > 10 {
                ...
                UIView.animate(withDuration: 0.2, animations:{
                    ...
                    self.menu_constraint.constant = -280
                    self.view.layoutIfNeeded()
    ...
    @IBAction func log_out_button(_ sender: Any) {
        ...
        PFUser.logOutInBackground { (error: Error?) in
            if (error == nil){
                ...
                self.performSegue(withIdentifier: "loading_injections_login", sender: nil)
                print("çıkıldı")
