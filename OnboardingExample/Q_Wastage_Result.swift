...
class Q_Wastage_Result: UIViewController {
    ...
    @IBOutlet weak var en_üst_layout: UIView!
    ...
    override func viewDidLoad() {
        ...
        let birinci_ilaç_layout = UIView(frame: CGRect(x: 40, y: 20 , width: ekran_boyutu.width - 60, height: ekran_boyutu.height / 5 ))
        birinci_ilaç_layout.layer.cornerRadius = 10
        
        
        
        let birinci_ilaç_image = UIImageView()
        birinci_ilaç_image.frame = CGRect(x: -20, y: 15, width: ((ekran_boyutu.height / 5 ) - 30) / 2, height: (ekran_boyutu.height / 5 ) - 30  )
        ...
        ilaç_adı_label_1 = UILabel(frame: CGRect(x: birinci_ilaç_layout.frame.height * 0.48, y: birinci_ilaç_layout.frame.height * 0.21 , width: 300, height: birinci_ilaç_layout.frame.height * 0.13))
        ...
        let cizgi_1_1 = UIView(frame: CGRect(x: birinci_ilaç_layout.frame.height * 0.48, y: birinci_ilaç_layout.frame.height * 0.42 , width: ekran_boyutu.width - 60 - birinci_ilaç_image.frame.maxX - 40 , height: 1 ))
        ...
        dose_1_başlık = UILabel(frame: CGRect(x: birinci_ilaç_layout.frame.height * 0.48, y: birinci_ilaç_layout.frame.height * 0.53 , width: 300, height: birinci_ilaç_layout.frame.height * 0.1))
        dose_1_başlık.text = "DOSE"
        dose_1_başlık.textColor = .white
        dose_1_başlık.font = UIFont(name: "TradeGothicLT-BoldCondTwenty", size: 19)
        dose_1_başlık.font = dose_1_başlık.font.withSize(birinci_ilaç_layout.frame.height * 0.1)
        birinci_ilaç_layout.addSubview(dose_1_başlık)
        
        
        
        
        dose_label_1 = UILabel(frame: CGRect(x: birinci_ilaç_layout.frame.height * 0.48, y: birinci_ilaç_layout.frame.height * 0.653 , width: 300, height: birinci_ilaç_layout.frame.height * 0.15))
        dose_label_1.text = "30 mg"
        dose_label_1.textColor = .white
        dose_label_1.font = UIFont(name: "TradeGothicLT-BoldCondTwenty", size: 19)
        dose_label_1.font = dose_1_başlık.font.withSize(birinci_ilaç_layout.frame.height * 0.12)
        birinci_ilaç_layout.addSubview(dose_label_1)
        
        
        
        amount_1_başlık = UILabel(frame: CGRect(x: birinci_ilaç_layout.frame.width * 0.47 , y: birinci_ilaç_layout.frame.height * 0.53 , width: 300, height: birinci_ilaç_layout.frame.height * 0.1))
        ...
        amount_1_başlık.font = amount_1_başlık.font.withSize(birinci_ilaç_layout.frame.height * 0.1)
        birinci_ilaç_layout.addSubview(amount_1_başlık)
        
        
        
        amount_label_1 = UILabel(frame: CGRect(x: birinci_ilaç_layout.frame.width * 0.47 , y: birinci_ilaç_layout.frame.height * 0.653 , width: 300, height: birinci_ilaç_layout.frame.height * 0.15))
        ...
        amount_label_1.font = amount_label_1.font.withSize(birinci_ilaç_layout.frame.height * 0.12)
        ...
        form_1_başlık.font = form_1_başlık.font.withSize(birinci_ilaç_layout.frame.height * 0.1)
        ...
        form_label_1.font = form_label_1.font.withSize(birinci_ilaç_layout.frame.height * 0.12)
        ...
        let ikinci_ilaç_layout = UIView(frame: CGRect(x: 40, y: (ekran_boyutu.height / 5 ) + 30  , width: ekran_boyutu.width - 60, height: ekran_boyutu.height / 5  ))
        ...
        ikinci_ilaç_image.frame = CGRect(x: -20, y: 15, width: ((ekran_boyutu.height / 5 ) - 30) / 2, height: (ekran_boyutu.height / 5 ) - 30  )
        ikinci_ilaç_image.image = UIImage(named: "pill_sky_blue")
        ikinci_ilaç_layout.addSubview(ikinci_ilaç_image)
        
        
        
        ilaç_adı_label_2 = UILabel(frame: CGRect(x: birinci_ilaç_layout.frame.height * 0.48, y: birinci_ilaç_layout.frame.height * 0.21 , width: 300, height: birinci_ilaç_layout.frame.height * 0.13))
        ...
        let cizgi_1_2 = UIView(frame: CGRect(x: birinci_ilaç_layout.frame.height * 0.48, y: birinci_ilaç_layout.frame.height * 0.42 , width: ekran_boyutu.width - 60 - birinci_ilaç_image.frame.maxX - 40 , height: 1 ))
        ...
        dose_2_başlık = UILabel(frame: CGRect(x: birinci_ilaç_layout.frame.height * 0.48, y: birinci_ilaç_layout.frame.height * 0.53 , width: 300, height: birinci_ilaç_layout.frame.height * 0.1))
        dose_2_başlık.text = "DOSE"
        dose_2_başlık.textColor = .white
        dose_2_başlık.font = UIFont(name: "TradeGothicLT-BoldCondTwenty", size: 19)
        dose_2_başlık.font = dose_2_başlık.font.withSize(birinci_ilaç_layout.frame.height * 0.1)
        ikinci_ilaç_layout.addSubview(dose_2_başlık)
        
        
        
        
        dose_label_2 = UILabel(frame: CGRect(x: birinci_ilaç_layout.frame.height * 0.48, y: birinci_ilaç_layout.frame.height * 0.653 , width: 300, height: birinci_ilaç_layout.frame.height * 0.15))
        dose_label_2.text = "30 mg"
        dose_label_2.textColor = .white
        dose_label_2.font = UIFont(name: "TradeGothicLT-BoldCondTwenty", size: 19)
        dose_label_2.font = dose_label_2.font.withSize(birinci_ilaç_layout.frame.height * 0.12)
        ikinci_ilaç_layout.addSubview(dose_label_2)
        
        
        
        amount_2_başlık = UILabel(frame: CGRect(x: birinci_ilaç_layout.frame.width * 0.47 , y: birinci_ilaç_layout.frame.height * 0.53 , width: 300, height: birinci_ilaç_layout.frame.height * 0.1))
        ...
        amount_2_başlık.font = amount_2_başlık.font.withSize(birinci_ilaç_layout.frame.height * 0.1)
        ikinci_ilaç_layout.addSubview(amount_2_başlık)
        
        
        
        amount_label_2 = UILabel(frame: CGRect(x: birinci_ilaç_layout.frame.width * 0.47 , y: birinci_ilaç_layout.frame.height * 0.653 , width: 300, height: birinci_ilaç_layout.frame.height * 0.15))
        ...
        amount_label_2.font = amount_label_2.font.withSize(birinci_ilaç_layout.frame.height * 0.12)
        ...
        form_2_başlık.font = form_2_başlık.font.withSize(birinci_ilaç_layout.frame.height * 0.1)
        ...
        form_label_2.font = form_2_başlık.font.withSize(birinci_ilaç_layout.frame.height * 0.12)
        ...
        let üçüncü_ilaç_layout = UIView(frame: CGRect(x: 40, y: ((ekran_boyutu.height / 5) * 2) + 40   , width: ekran_boyutu.width - 60, height: ekran_boyutu.height / 5  ))
        üçüncü_ilaç_layout.layer.cornerRadius = 10
        
        
        
        let üçüncü_ilaç_image = UIImageView()
        üçüncü_ilaç_image.frame = CGRect(x: -20, y: 15, width: ((ekran_boyutu.height / 5 ) - 30) / 2, height: (ekran_boyutu.height / 5 ) - 30  )
        ...
        ilaç_adı_label_3 = UILabel(frame: CGRect(x: birinci_ilaç_layout.frame.height * 0.48, y: birinci_ilaç_layout.frame.height * 0.21 , width: 300, height: birinci_ilaç_layout.frame.height * 0.13))
        ...
        let cizgi_1_3 = UIView(frame: CGRect(x: birinci_ilaç_layout.frame.height * 0.48, y: birinci_ilaç_layout.frame.height * 0.42 , width: ekran_boyutu.width - 60 - birinci_ilaç_image.frame.maxX - 40 , height: 1 ))
        ...
        dose_3_başlık = UILabel(frame: CGRect(x: birinci_ilaç_layout.frame.height * 0.48, y: birinci_ilaç_layout.frame.height * 0.53 , width: 300, height: birinci_ilaç_layout.frame.height * 0.1))
        dose_3_başlık.text = "DOSE"
        dose_3_başlık.textColor = .white
        dose_3_başlık.font = UIFont(name: "TradeGothicLT-BoldCondTwenty", size: 19)
        dose_3_başlık.font = dose_3_başlık.font.withSize(birinci_ilaç_layout.frame.height * 0.1)
        üçüncü_ilaç_layout.addSubview(dose_3_başlık)
        
        
        
        
        dose_label_3 = UILabel(frame: CGRect(x: birinci_ilaç_layout.frame.height * 0.48, y: birinci_ilaç_layout.frame.height * 0.653 , width: 300, height: birinci_ilaç_layout.frame.height * 0.15))
        dose_label_3.text = "30 mg"
        dose_label_3.textColor = .white
        dose_label_3.font = UIFont(name: "TradeGothicLT-BoldCondTwenty", size: 19)
        dose_label_3.font = dose_label_3.font.withSize(birinci_ilaç_layout.frame.height * 0.12)
        üçüncü_ilaç_layout.addSubview(dose_label_3)
        
        
        
        amount_3_başlık = UILabel(frame: CGRect(x: birinci_ilaç_layout.frame.width * 0.47 , y: birinci_ilaç_layout.frame.height * 0.53 , width: 300, height: birinci_ilaç_layout.frame.height * 0.1))
        ...
        amount_3_başlık.font = amount_3_başlık.font.withSize(birinci_ilaç_layout.frame.height * 0.1)
        üçüncü_ilaç_layout.addSubview(amount_3_başlık)
        
        
        
        amount_label_3 = UILabel(frame: CGRect(x: birinci_ilaç_layout.frame.width * 0.47 , y: birinci_ilaç_layout.frame.height * 0.653 , width: 300, height: birinci_ilaç_layout.frame.height * 0.15))
        ...
        amount_label_3.font = amount_label_3.font.withSize(birinci_ilaç_layout.frame.height * 0.12)
        ...
        form_3_başlık.font = form_3_başlık.font.withSize(birinci_ilaç_layout.frame.height * 0.1)
        ...
        form_label_3.font = form_label_3.font.withSize(birinci_ilaç_layout.frame.height * 0.12)
        ...
        let alt_layout = UIView(frame: CGRect(x: 15, y: ((ekran_boyutu.height / 5) * 3) + 40, width: ekran_boyutu.width - 30, height: ekran_boyutu.height - 50 ))
        ...
        if (ilaç_sıralaması.contains("Syyy")){
            ...
            alt_layout.frame = CGRect(x: 15 , y:  birinci_ilaç_layout.frame.height + 20  , width: ekran_boyutu.width - 30 , height: ekran_boyutu.height - 50 )
            self.ana_view_result.addSubview(alt_layout)
